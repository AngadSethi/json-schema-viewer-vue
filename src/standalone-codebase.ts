 ...
 */
export function createRender<Props extends Parameters<typeof React.createElement>[1]>(
 ...
 * @param {Any} component of any kind
 */
export function createHydrate<Props extends Parameters<typeof React.createElement>[1]>(
  component: Parameters<typeof React.createElement>[0],
) {
